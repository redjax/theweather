...
logs_weatherapi_collector() {
    cd "$REPO_ROOT"

    echo "Showing logs of weatherapi-collector container"

    local cmd=(docker compose -f "$WEATHERAPI_COLLECTOR_CONTAINER_DIR/compose.yml" logs -f weatherapi-collector)
